================================================================================
    MFC 라이브러리 : 20220224 프로젝트 개요
===============================================================================

응용 프로그램 마법사에서 이 20220224 응용 프로그램을 만들었습니다. 이 응용 프로그램은 MFC의 기본 사용법을 보여 줄 뿐만 아니라 응용 프로그램을 작성하기 위한 기본 구조를 제공합니다.
...
20220224.h
    ...
    여기에는 resource.h를 비롯한 다른 프로젝트별 헤더가 포함되어 있으며 CMy20220224App 응용 프로그램 클래스가 선언되어 있습니다.

20220224.cpp
    이는 응용 프로그램 클래스 CMy20220224App가 포함된 기본 응용 프로그램 소스 파일입니다.
...
res\20220224.ico
    아이콘 파일이며, 응용 프로그램의 아이콘으로 사용됩니다. 이 아이콘은 기본 리소스 파일인 20220224.rc에 의해 포함됩니다.
